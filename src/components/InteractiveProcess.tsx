...
const CONFIG: { colors: any; steps: Step[] } = {
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        "אתם בוחרים את הסגנון הויזואלי המדויק שמתאים למותג שלכם. בין אם זה נקי ומודרני, חם וכפרי, יוקרתי ואלגנטי או נועז וצבעוני – אנחנו מתאימים את התמונות ל-DNA העיצובי שלכם כמו כפפה ליד.",
      layout: "grid",
      images: [
